-- BINGO Admin Cancellation Dashboard V2 fix
-- delivery_assignments has no created_at column in this schema.
-- Use a stable assignment choice without relying on that missing column.
