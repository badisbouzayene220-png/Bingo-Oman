...
function init(){
  ...
  const ar=isArabic();const root=document.createElement('div');root.id='bingoSafeIntro';root.setAttribute('role','dialog');root.setAttribute('aria-modal','true');root.setAttribute('aria-label','BINGO Oman introduction');root.innerHTML=`
    ...
    <div class="bsi-stage">
      ...
      <div class="bsi-phase bsi-logo-phase"><div class="bsi-logo-fallback" aria-hidden="true">BINGO <span>OMAN</span></div><img class="bsi-logo" src="assets/bingo-oman-intro.png?v=${ASSET_VERSION}" alt="BINGO Oman"></div>
      <div class="bsi-phase bsi-mascot-phase"><div class="bsi-mascot-card"><img class="bsi-mascot" src="assets/characters/bingo-mascot-phone-v2.png?v=${ASSET_VERSION}" alt="BINGO Oman mascot and Oman map"></div></div>
