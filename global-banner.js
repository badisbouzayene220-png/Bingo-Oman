(function(){
  ...
  function render(){
    ...
    const media=a.media_type==='video'
      ? '<video class="bingo-global-media" src="'+esc(a.media_url)+'" autoplay muted loop playsinline></video>'
      : '<img class="bingo-global-media" src="'+esc(a.media_url)+'" alt="'+esc(a.title||'Advertisement')+'" loading="eager">';
