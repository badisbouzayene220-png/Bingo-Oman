(function () {
  ...
  const LEGACY_EN_AR = {
    ...
    "Account profile": "بيانات الحساب",
    "Loading profile…": "جارٍ تحميل بيانات الحساب…",
    ...
    "Cancel": "إلغاء",
    "+ Create listing": "+ إضافة إعلان",
    "Browse marketplace": "تصفح السوق",
    "My listings": "إعلاناتي",
    "❤️ My Favorites": "❤️ المفضلة",
    "Saved listings linked to your BINGO account.": "الإعلانات المحفوظة في حساب BINGO الخاص بك.",
    "Loading favorites…": "جارٍ تحميل المفضلة…",
    "No favorites yet": "لا توجد عناصر مفضلة بعد",
    "Save listings you like and they will appear here.": "احفظ الإعلانات التي تعجبك وستظهر هنا.",
    "Explore listings": "استكشف الإعلانات",
    "View": "عرض",
    "Remove": "إزالة",
    ...
    "Sold": "تم البيع",
    "Archived": "مؤرشف",
    "Profile details are temporarily unavailable.": "بيانات الحساب غير متاحة مؤقتًا.",
    ...
    "Create your first listing and it will appear here.": "أنشئ إعلانك الأول وسيظهر هنا.",
